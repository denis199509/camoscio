...
async function loadTrailIndex() {
    ...
    // sono anche le carrarecce e le stradine entro 200 m dalla rete conosciuta, servite
    // alla progettazione di un percorso (livello i). Sono piu' del doppio dei dati.
