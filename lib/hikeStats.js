...
// Ritorna false (nessun Completion creato, nessuna statistica toccata) se questa persona
// aveva gia' un Completion per questa escursione - rispetta cosi' l'indice unico
// userId+hikeId senza sollevare un errore: nel completamento di gruppo non e' un problema,
// e' il caso normale di chi si era gia' auto-completato in passato.
async function applyHikeCompletionStats(user, hike, actualTimeHours) {
    ...
    // reale - il completamento di gruppo (punto 64) non ne dichiara mai uno: Denis non ha
    // mai parlato di tempo/durata per quel flusso, riguarda solo "chi c'era".
