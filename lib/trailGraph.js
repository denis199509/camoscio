...
async function progettaPercorso(punti, opzioni = {}) {
    ...
    return {
        ...
        // NON si restituisce nessun dislivello, e non e' una dimenticanza: i sentieri sul
        // database non hanno la quota (0 su 15.228 misurati). Dare un dislivello inventato
        // per un'escursione da preparare sarebbe la cosa peggiore di tutte.
        dislivelloDisponibile: false
    };
}
