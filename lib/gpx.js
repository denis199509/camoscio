...
//
// E' 10 e non 3 come MIN_ELEVATION_DELTA_M del tracciamento dal vivo perche' i due numeri non
// misurano la stessa cosa: dal vivo i 3 metri sono il salto fra DUE PUNTI CONSECUTIVI, qui i
// 10 metri sono quanto si e' saliti in tutto sopra l'ultimo avvallamento. Servono due regole
// diverse perche' i dati sono diversi: dal vivo i punti arrivano a gruppi e il totale si
// aggiorna man mano, quindi non si puo' guardare tutta la traccia insieme; qui la traccia c'e'
// tutta e si puo' fare il conto giusto.
...
module.exports = { parseGpx, statisticheTraccia, ErroreGpx, MAX_PUNTI, SOGLIA_DISLIVELLO_M };
