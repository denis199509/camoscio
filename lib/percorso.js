...
function misureDaSessione(sessione) {
    ...
    const maxDaiPunti = quote.length ? Math.round(Math.max(...quote)) : null;

    return {
        sostanziale,
        maxAltitude: sostanziale
        ...
        elevationGain: sostanziale ? Math.round(sessione.elevationGainM || 0) : null,
        distanceKm: sostanziale ? sessione.distanceKm : null,
