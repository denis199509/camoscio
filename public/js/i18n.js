...
(function () {
    ...
    const DICT = {
        en: {
            ...
            'hikeCard.tempoDatiMancanti': 'Estimated time not available: elevation gain or distance is missing for this route.',
            ...
            'settings.2faErroreGenerico': "Couldn't start the setup.",
            ...
            'settings.2faCodice6': 'The code has 6 digits.',
            'settings.2faCodiceNonValido': 'Invalid code.',
            'settings.2faOrologioIndietro': 'behind',
            'settings.2faOrologioAvanti': 'ahead',
            'settings.2faOrologioSfasato': "Your phone's clock seems {verso} by about {min} minutes: sync it and try again.",
            ...
            'settings.2faServePwd': 'Password required.',
            'settings.2faServeCodice': 'A code is required.',
            'settings.2faCredNonValide': 'Invalid password or code.',
            ...
            'settings.2faCopiaFallita': "Couldn't copy: select them by hand instead.",
            'settings.2faCodiciScarica': 'Download',
            'settings.2faScaricaFallita': 'Download failed.',
            'settings.2faCodiciStampa': 'Print',
            'settings.2faStampaBloccata': 'Printing was blocked by the browser.',
            ...
            'settings.recuperoAnnullaErrore': "There's no recovery in progress to cancel.",
            ...
            'backpack.js.badgeQuotaIgnota': 'Altitude not given',
            ...
            'backpack.js.alertQuotaIgnota': "Maximum altitude not given: the list is not applying the rules above 2500 m. Type the altitude next to the list and generate it again.",
            'backpack.js.alertQuotaIgnotaInverno': 'Without an altitude the season is treated as winter as a precaution: the winter mandatory items stay.',
            ...
            'track.liberaSpazioOffline': 'Free up space (downloaded offline maps)',
            'track.liberaSpazioConferma': 'Free up space',
            ...
            'track.erroreLiberaSpazio': 'Error while freeing up space.',
            'track.attendiFineDownload': 'Wait for the offline map download to finish before freeing up space.',
